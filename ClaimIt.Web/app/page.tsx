...
// Update the NetworkLines component to be more responsive and perform better on mobile
const NetworkLines = () => {
  ...
  useEffect(() => {
    ...
    const numPoints = isMobile ? 20 : 50
    ...
    const animate = () => {
      ...
      for (let i = 0; i < numPoints; i++) {
        ...
        // Draw point
        ctx.beginPath()
        ctx.arc(point.x, point.y, isMobile ? 0.5 : 1, 0, Math.PI * 2)
        ctx.fillStyle = "rgba(87, 179, 254, 0.3)"
        ctx.fill()

        // Connect to nearby points - limit connections on mobile
        const connectLimit = isMobile ? 3 : numPoints
...
// Update the main component to be more responsive
    ...
    >
        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="relative">
              <Coins className="h-5 w-5 sm:h-6 sm:w-6 text-[#57b3fe] animate-pulse" />
              <div className="absolute -inset-1 rounded-full blur-sm bg-[#57b3fe]/30 -z-10 animate-pulse"></div>
            </div>
            <span className="text-lg sm:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#57b3fe] to-[#c157fe] animate-gradient">
              ClaimIt
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Button
              asChild
              className="px-2 sm:px-4 text-xs sm:text-sm bg-gradient-to-r from-[#57b3fe] to-[#c157fe] hover:opacity-90 text-white shadow-lg shadow-[#57b3fe]/20 border-0 transition-all duration-300 hover:scale-105 hover:shadow-[#57b3fe]/40"
            >
      ...
      <main className="flex-1">
        <section className="w-full py-8 sm:py-12 md:py-24 lg:py-32 xl:py-48 relative overflow-hidden">
          ...
          {/* Network animation - only on tablet and up */}
          {!isMobile && <NetworkLines />}

          {/* Glowing orbs with animation */}
          <div className="absolute top-20 left-1/4 w-36 sm:w-72 h-36 sm:h-72 bg-[#57b3fe] rounded-full opacity-10 blur-[100px] animate-pulse"></div>
          <div
            className="absolute bottom-20 right-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-[#c157fe] rounded-full opacity-10 blur-[100px] animate-pulse"
              ...
              <AnimatedSection className="flex flex-col justify-center space-y-4">
                ...
                >
                  <Button
                    size="lg"
                    asChild
                    className="px-4 sm:px-8 text-xs sm:text-sm bg-gradient-to-r from-[#57b3fe] to-[#c157fe] hover:opacity-90 text-white shadow-lg shadow-[#57b3fe]/20 border-0 relative overflow-hidden group"
                  >
                    <Link href="#download">
                  ...
                  <Button
                    ...
                    variant="outline"
                    asChild
                    className="px-4 sm:px-8 text-xs sm:text-sm border-[#57b3fe] text-[#57b3fe] hover:bg-[#57b3fe]/10 hover:text-white transition-all duration-300"
                  >
                    <Link href="#how-it-works">See How It Works</Link>
                  </Button>
                </div>
                <div
                  className="flex items-center gap-2 text-xs sm:text-sm text-gray-400 animate-fadeIn"
                ...
                >
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="inline-block h-6 w-6 sm:h-8 sm:w-8 rounded-full bg-[#2a2d3a] ring-2 ring-[#0a0b14]"
                      />
                    ))}
                  </div>
                ...
                <FloatingElement className="relative w-full max-w-[500px] aspect-[4/3] overflow-hidden rounded-xl border border-[#2a2d3a] bg-[#151725] shadow-2xl">
                  ...
                  <div className="absolute inset-0 p-3 sm:p-5 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mb-3 sm:mb-5 px-2">
                      <div className="flex items-center gap-2">
                        <Coins className="h-4 w-4 sm:h-5 sm:w-5 text-[#57b3fe]" />
                        <span className="text-xs sm:text-sm font-bold text-white">ClaimIt Dashboard</span>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-5">
                      <div className="bg-[#1a1c2e] rounded-lg p-2 sm:p-3 border border-[#2a2d3a]">
                        <div className="text-[#57b3fe] text-[8px] sm:text-xs mb-1">Active Airdrops</div>
                        <div className="text-white text-xs sm:text-base font-bold">12</div>
                      </div>
                      <div className="bg-[#1a1c2e] rounded-lg p-2 sm:p-3 border border-[#2a2d3a]">
                        <div className="text-[#c157fe] text-[8px] sm:text-xs mb-1">Claimed Value</div>
                        <div className="text-white text-xs sm:text-base font-bold">$3,240</div>
                      </div>
                      <div className="bg-[#1a1c2e] rounded-lg p-2 sm:p-3 border border-[#2a2d3a]">
                        <div className="text-green-400 text-[8px] sm:text-xs mb-1">Completion</div>
                        <div className="text-white text-xs sm:text-base font-bold">87%</div>
                      </div>
                    </div>

                    {/* Airdrop list */}
                    <div className="flex-1 bg-[#1a1c2e] rounded-lg border border-[#2a2d3a] overflow-hidden">
                      <div className="bg-[#151725] px-3 py-2 border-b border-[#2a2d3a] flex justify-between items-center">
                        <span className="text-[10px] sm:text-xs text-white font-medium">Active Airdrops</span>
                        <div className="flex items-center gap-1 text-[#57b3fe] text-[8px] sm:text-xs">
                          <span>View All</span>
                      ...
                      <div className="p-2 sm:p-3 space-y-2 sm:space-y-3">
                        {/* Airdrop items */}
                        {[
                          { name: "Arbitrum", symbol: "ARB", progress: 90, value: "$850", color: "#2D374B" },
                          { name: "Optimism", symbol: "OP", progress: 75, value: "$420", color: "#FF0420" },
                          { name: "ZkSync", symbol: "ZK", progress: 60, value: "$320", color: "#4E529A" },
                        ].map((airdrop, i) => (
                          <div
                            key={i}
                            className="bg-[#151725] rounded-md p-2 border border-[#2a2d3a] flex items-center justify-between"
                          >
                            <div className="flex items-center gap-2">
                              <div
                              ...
                              >
                                <span className="text-[8px] sm:text-xs text-white font-bold">{airdrop.symbol}</span>
                              </div>
                              <div>
                                <div className="text-[10px] sm:text-xs text-white font-medium">{airdrop.name}</div>
                                <div className="text-[8px] sm:text-[10px] text-gray-400">
                                  Progress: {airdrop.progress}%
                                </div>
                              </div>
                            </div>
                            <div className="text-[10px] sm:text-xs text-[#57b3fe] font-bold">{airdrop.value}</div>
                          </div>
                        ))}

                        {/* New airdrop notification */}
                        <div className="bg-gradient-to-r from-[#1a1c2e] to-[#2a2d3a] rounded-md p-2 border border-[#57b3fe]/30 flex items-center justify-between animate-pulse">
                          <div className="flex items-center gap-2">
                            <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-[#57b3fe]/20 flex items-center justify-center">
                              <Bell className="h-3 w-3 sm:h-4 sm:w-4 text-[#57b3fe]" />
                            </div>
                            <div>
                              <div className="text-[10px] sm:text-xs text-white font-medium">
                                New Airdrop Available!
                              </div>
                              <div className="text-[8px] sm:text-[10px] text-gray-400">Tap to view details</div>
                            </div>
                          </div>
                          <div className="text-[10px] sm:text-xs text-[#57b3fe] font-bold">$???</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Glow effect */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#57b3fe] to-[#c157fe] opacity-20 blur-sm rounded-xl"></div>
                </FloatingElement>
              </AnimatedSection>
            </div>
          </div>
        ...
        <section id="features" className="w-full py-8 sm:py-12 md:py-24 lg:py-32 relative">
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <AnimatedSection className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-[#2a2d3a] px-3 py-1 text-xs sm:text-sm text-[#57b3fe] font-medium animate-fadeIn">
                  Powerful Features
                </div>
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#57b3fe] to-[#c157fe] animate-gradient">
                  Everything You Need to Maximize Your Airdrops
                </h2>
                <p className="max-w-[900px] text-gray-400 text-xs sm:text-sm md:text-base lg:text-xl">
                ...
                <AnimatedSection key={i} style={{ animationDelay: `${i * 0.1}s` }}>
                  <Card className="overflow-hidden border border-[#2a2d3a] bg-[#151725] hover:shadow-lg hover:shadow-[#57b3fe]/5 transition-all duration-300 group relative hover:-translate-y-1">
                    ...
                    <CardHeader className="pb-2 relative p-4 sm:p-6">
                      ...
                      <CardTitle className="text-[#57b3fe] text-base sm:text-lg">{feature.title}</CardTitle>
        ...
        <section className="w-full py-8 sm:py-12 md:py-24 lg:py-32 bg-[#0d0e18] relative overflow-hidden">
          {/* Circuit board pattern */}
          <div className="absolute inset-0 bg-[url('/placeholder.svg?height=200&width=200')] opacity-5"></div>

          {/* Glowing orb with animation */}
          <div className="absolute top-1/2 left-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-[#57b3fe] rounded-full opacity-5 blur-[100px] transform -translate-y-1/2 animate-pulse"></div>

          <div className="container px-4 md:px-6 relative z-10">
            <div className="grid gap-8 lg:gap-10 lg:grid-cols-2 lg:gap-16">
              <AnimatedSection className="space-y-4">
                ...
                <p className="text-gray-400 text-xs sm:text-sm md:text-base lg:text-xl">
                  ...
                  {[
                    ...
                    <AnimatedSection key={i} style={{ animationDelay: `${i * 0.1 + 0.3}s` }}>
                      <li className="flex items-center gap-2 hover:translate-x-1 transition-transform duration-300">
                        <div className="flex h-5 w-5 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-[#2a2d3a] relative">
                          <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4 text-[#57b3fe]" />
                ...
                >
                  <Button
                    size="lg"
                    asChild
                    className="px-4 sm:px-8 text-xs sm:text-sm bg-gradient-to-r from-[#57b3fe] to-[#c157fe] hover:opacity-90 text-white shadow-lg shadow-[#57b3fe]/20 border-0 group hover:scale-105 transition-transform duration-300"
                  >
                    <Link href="#download">
                      Get ClaimIt Now{" "}
                      <ArrowRight className="ml-1 sm:ml-2 h-3 w-3 sm:h-4 sm:w-4 group-hover:translate-x-1 transition-transform duration-300" />
              ...
              >
                <FloatingElement className="relative w-full max-w-[500px] aspect-square overflow-hidden rounded-xl border border-[#2a2d3a] bg-[#151725] shadow-2xl">
                  ...
                  {/* Animated data visualization elements - fewer on mobile */}
                  {!isMobile && (
                    <>
                      <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#57b3fe] rounded-full animate-ping"></div>
                      <div
        ...
        <section id="how-it-works" className="w-full py-8 sm:py-12 md:py-24 lg:py-32 relative">
          {/* Hexagon pattern background */}
          <div className="absolute inset-0 bg-[url('/placeholder.svg?height=60&width=60')] opacity-5 bg-repeat"></div>
            ...
            <div className="mx-auto grid max-w-5xl gap-4 sm:gap-6 py-8 sm:py-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  icon: <Wallet className="h-8 w-8 sm:h-10 sm:w-10 text-white" />,
                },
                {
                  step: "03",
                  title: "Claim Rewards",
                  description: "Sit back and collect your airdrops as they become available",
                  icon: <Gift className="h-8 w-8 sm:h-10 sm:w-10 text-white" />,
                },
              ].map((item, i) => (
                <AnimatedSection key={i} style={{ animationDelay: `${i * 0.2}s` }}>
                  <Card className="relative overflow-hidden border-0 bg-transparent hover:scale-105 transition-transform duration-500">
                    ...
                    <CardHeader className="pb-2 relative z-10 p-4 sm:p-6">
                      <span
                        className="absolute right-4 top-4 text-xl sm:text-3xl font-bold text-white/10 animate-fadeIn"
                        style={{ animationDelay: "0.5s" }}
                      >
                        {item.step}
                      </span>
                      <div className="mb-2 bg-[#2a2d3a] p-2 sm:p-3 rounded-full w-fit relative group">
                      ...
                      <CardDescription className="text-gray-400 text-xs sm:text-sm">{item.description}</CardDescription>
                    </CardHeader>
                  </Card>
                </AnimatedSection>
              ))}
        ...
        <section id="testimonials" className="w-full py-8 sm:py-12 md:py-24 lg:py-32 bg-[#0d0e18] relative">
          {/* Circuit board pattern */}
          <div className="absolute inset-0 bg-[url('/placeholder.svg?height=200&width=200')] opacity-5"></div>
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <AnimatedSection className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-[#2a2d3a] px-3 py-1 text-xs sm:text-sm text-[#57b3fe] animate-fadeIn">
                  Testimonials
                </div>
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#57b3fe] to-[#c157fe] animate-gradient">
                  What Our Users Say
                  ...
                  <Card className="text-left border border-[#2a2d3a] bg-[#151725] relative group hover:scale-105 transition-transform duration-300">
                    ...
                    <CardContent className="pt-4 sm:pt-6 p-4 sm:p-6">
                      <div className="flex flex-col gap-3 sm:gap-4">
                        <div className="flex gap-1 animate-fadeIn" style={{ animationDelay: `${i * 0.1 + 0.3}s` }}>
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg
                              ...
                              viewBox="0 0 24 24"
                              fill="currentColor"
                              className="h-4 w-4 sm:h-5 sm:w-5 text-[#57b3fe] animate-pulse"
                        ...
                        <p className="text-gray-400 text-xs sm:text-sm">"{item.quote}"</p>
                        <div className="animate-fadeIn" style={{ animationDelay: `${i * 0.1 + 0.6}s` }}>
                          <p className="font-medium text-white text-sm sm:text-base">{item.author}</p>
        ...
        <section id="download" className="w-full py-8 sm:py-12 md:py-24 lg:py-32 relative overflow-hidden">
          {/* Animated gradient background */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#0d0e18] to-[#151725]"></div>

          {/* Glowing orbs with animation */}
          <div className="absolute top-1/4 left-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-[#57b3fe] rounded-full opacity-10 blur-[100px] animate-pulse"></div>
          <div
            className="absolute bottom-1/4 right-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-[#c157fe] rounded-full opacity-10 blur-[100px] animate-pulse"
          ...
          {/* Floating particles - fewer on mobile */}
          <Particles quantity={isMobile ? 30 : 70} />

          <div className="container px-4 md:px-6 relative z-10">
            <AnimatedSection className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#57b3fe] to-[#c157fe] animate-gradient">
              ...
              <div className="mx-auto w-full max-w-sm space-y-2">
                ...
                >
                  <Button
                    ...
                    variant="secondary"
                    asChild
                    className="px-4 sm:px-8 text-xs sm:text-sm bg-[#2a2d3a] text-white hover:bg-[#3a3d4a] border-0 relative group overflow-hidden hover:scale-105 transition-transform duration-300"
                  >
                    <Link href="#chrome" className="flex items-center">
                      ...
                      <div className="relative z-10 flex items-center">
                        <Image
                          ...
                          height={24}
                          alt="Chrome"
                          className="mr-1 sm:mr-2 h-4 w-4 sm:h-5 sm:w-5 animate-spin-slow"
                        />
                        Add to Chrome
                      </div>
                    </Link>
                ...
                <p className="text-xs sm:text-sm text-gray-500 animate-fadeIn" style={{ animationDelay: "0.8s" }}>
        ...
        <section className="w-full py-8 sm:py-12 md:py-24 lg:py-32 bg-[#0a0b14] border-t border-[#2a2d3a] relative">
          <div className="absolute inset-0 bg-[url('/placeholder.svg?height=60&width=60')] opacity-5 bg-repeat"></div>

          <div className="container px-4 md:px-6 relative z-10">
            <div className="grid gap-8 sm:gap-10 md:gap-16 grid-cols-1 md:grid-cols-2">
              <AnimatedSection className="space-y-4">
                <div className="inline-block rounded-lg bg-[#2a2d3a] px-3 py-1 text-xs sm:text-sm text-[#57b3fe] animate-fadeIn">
                  Limited Time Offer
                </div>
                ...
                <p className="max-w-[600px] text-gray-400 text-xs sm:text-sm md:text-base lg:text-xl">
              ...
              <AnimatedSection
                className="flex flex-col items-start space-y-4 mt-8 md:mt-0"
                style={{ animationDelay: "0.3s" }}
              >
                <div className="inline-block rounded-lg bg-[#2a2d3a] px-3 py-1 text-xs sm:text-sm text-[#57b3fe] animate-fadeIn">
                  Coming Soon
                ...
                <Button
                  ...
                  size="lg"
                  asChild
                  className="px-4 sm:px-8 text-xs sm:text-sm border-[#57b3fe] text-[#57b3fe] hover:bg-[#57b3fe]/10 hover:text-white group hover:scale-105 transition-transform duration-300"
                >
                  <Link href="#waitlist">
                    Join Waitlist{" "}
                    <ArrowRight className="ml-1 sm:ml-2 h-3 w-3 sm:h-4 sm:w-4 group-hover:translate-x-1 transition-transform duration-300" />
      ...
      <footer className="w-full border-t border-[#2a2d3a] bg-[#0a0b14] py-4 sm:py-6 md:py-12">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base sm:text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#57b3fe] to-[#c157fe] animate-gradient">
              ClaimIt
            </span>
          </div>
          ...
          <div className="flex gap-4">
            <Link
              href="#"
              className="text-xs sm:text-sm text-gray-500 hover:text-[#57b3fe] transition-colors hover:scale-105 transform duration-200"
            >
              Privacy Policy
            </Link>
            <Link
